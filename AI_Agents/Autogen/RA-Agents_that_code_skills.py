...
# First skill/function: Get stock prices
...
# Second skill/function: Plot stock prices
...
# Let agent know about two functions
...
"Create a plot showing the normalized price of NVDA and MSFT for the last 5 years. "\
